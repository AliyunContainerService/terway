...
func (_m *Interface) AssignIpv6Addresses(ctx context.Context, eniID string, count int, idempotentKey string) ([]netip.Addr, error) {
...
func (_m *Interface) AssignPrivateIPAddress(ctx context.Context, eniID string, count int, idempotent string) ([]netip.Addr, error) {
...
func (_m *Interface) CreateNetworkInterface(ctx context.Context, trunk bool, erdma bool, vSwitchID string, securityGroups []string, resourceGroupID string, ipCount int, ipv6Count int, eniTags map[string]string) (*client.NetworkInterface, error) {
