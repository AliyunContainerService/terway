...
func (_m *ECS) DescribeNetworkInterfaceAttribute(ctx context.Context, eniID string) (*client.NetworkInterface, error) {
	...
	var r0 *client.NetworkInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*client.NetworkInterface, error)); ok {
		return rf(ctx, eniID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *client.NetworkInterface); ok {
		r0 = rf(ctx, eniID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.NetworkInterface)
