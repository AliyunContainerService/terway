...
func main() {
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElection:             true,
		LeaderElectionID:           uuid.New().String() + "-" + os.Getenv("K8S_POD_NAME"),
	...
	mgr.GetWebhookServer().Register("/validate", webhook.ValidateHook(mgr.GetClient()))
